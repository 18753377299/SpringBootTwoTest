...
public class ExcelContext  {
	 ...
	 * @throws Exception 
	 */
	public ExcelImportResult readExcel(String id, InputStream excelStream, String path, String projectUrl) throws Exception {
		return excelImport.readExcel(id,0, excelStream,null,false,path,projectUrl);
	}
	 ...
	 * @throws Exception 
	 */
	public ExcelImportResult readExcel(String id, InputStream excelStream, int sheetIndex, String path, String projectUrl) throws Exception {
		return excelImport.readExcel(id,0, excelStream,sheetIndex,false,path,projectUrl);
	}
	 ...
	 * @throws Exception 
	 */
	public ExcelImportResult readExcel(String id, int titleIndex, InputStream excelStream, String path, String projectUrl) throws Exception {
		return excelImport.readExcel(id,titleIndex, excelStream,null,true,path,projectUrl);
	}
	 ...
	 * @throws Exception 
	 */
	public ExcelImportResult readExcel(String id, int titleIndex, InputStream excelStream, boolean multivalidate, String path, String projectUrl) throws Exception {
		return excelImport.readExcel(id,titleIndex, excelStream,null,multivalidate,path,projectUrl);
	}
	 ...
	 * @throws Exception 
	 */
	public ExcelImportResult readExcel(String id, int titleIndex, InputStream excelStream, int sheetIndex, String path, String projectUrl) throws Exception {
		return excelImport.readExcel(id,titleIndex, excelStream,sheetIndex,false,path,projectUrl);
	}
	 ...
	 * @throws Exception 
	 */
	public ExcelImportResult readExcel(String id, int titleIndex, InputStream excelStream, int sheetIndex, boolean multivalidate, String path, String projectUrl) throws Exception {
		return excelImport.readExcel(id,titleIndex, excelStream,sheetIndex,multivalidate,path,projectUrl);
	}
