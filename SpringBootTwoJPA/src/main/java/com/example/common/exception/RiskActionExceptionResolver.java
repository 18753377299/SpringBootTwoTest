package com.example.common.exception;//package com.example.common.exception;
//
//
...
//        log.info("==> 请求风控微服务中台参数校验异常 字段 = {}, 异常 = {}", field, defaultMessage);
//
//        return BaseController.error(null, BaseController.setParamCheckErrorMessage(field, defaultMessage));
//    }
//}
